var Client = IgeClass.extend({
	...
	init: function () {
		...
		gameTexture[0] = new IgeTexture('/static/engine/game-assets/textures/sprites/fairy.png');
		gameTexture[1] = new IgeCellSheet('/static/engine/game-assets/textures/tiles/grassSheet.png', 4, 1);
		gameTexture[2] = new IgeCellSheet('/static/engine/game-assets/textures/tiles/tilea5b.png', 8, 16);
